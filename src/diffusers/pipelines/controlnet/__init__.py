...
try:
    ...
    _import_structure["pipeline_controlnet_grounded"] = ["StableDiffusionControlNetGroundedPipeline"]
...
if TYPE_CHECKING:
    try:
        ...
        from .pipeline_controlnet_grounded import StableDiffusionControlNetGroundedPipeline
